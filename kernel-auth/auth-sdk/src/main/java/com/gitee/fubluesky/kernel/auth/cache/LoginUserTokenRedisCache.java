 ...
 */
public class LoginUserTokenRedisCache extends AbstractRedisCacheOperator<LoginUser> {

	public LoginUserTokenRedisCache(RedisTemplate<String, LoginUser> redisTemplate) {
		super(redisTemplate);
	}
