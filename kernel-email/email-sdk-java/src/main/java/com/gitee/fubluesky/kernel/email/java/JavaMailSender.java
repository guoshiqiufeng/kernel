...
public class JavaMailSender implements MailSenderApi {
    ...
    private void checkMailParam(SendMailParam sendMailParam) {
        ...
        // 收件人邮箱
        if (StrUtil.isEmpty(sendMailParam.getTo())) {
